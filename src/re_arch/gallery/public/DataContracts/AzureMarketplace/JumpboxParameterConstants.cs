...
namespace Luna.Gallery.Public.Client
{
    public class JumpboxParameterConstants
    {
        ...
        public const string JUMPBOX_VM_SSH_KEY_PARAM_NAME = "luna-jumpbox-ssh-key";
        ...
        public const string JUMPBOX_VM_TENANT_ID_PARAM_NAME = "luna-jumpbox-azure-tenant-id";
